...
while True:
    ...
    -c:v libx264 -preset fast -b:v 2500k -maxrate 3000k -bufsize 6000k -pix_fmt yuv420p -c:a aac -b:a 192k -ar 48000 -f flv "{RTMP_URL}"
    """
    ...
    try:
        ...
        for line in process.stderr:
            print(line.strip())  # Print FFmpeg errors
    except Exception as e:
        print(f"⚠ FFmpeg crashed: {e}. Restarting...")

    print("⏳ Waiting 5 seconds before playing next movie...")
    time.sleep(5)  # Short pause before selecting the next movie
