...
def stream_movie(movie):
    ...
    -filter_complex "[1:v]scale=main_w:main_h:force_original_aspect_ratio=0[ovr];[0:v][ovr]overlay=0:0,drawtext=text='{overlay_text}':fontcolor=white:fontsize=24:x=20:y=20" \
